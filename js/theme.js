...
function setTheme(mode, selectionMode) {
	...
	var svgObj = banner.contentDocument;
	var wLamp = svgObj.getElementById("wLamp");
	var yGlow = svgObj.getElementById("yGlow");
